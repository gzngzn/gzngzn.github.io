    ...
    constructor() {
        this.portfolioItems = [
            { name: 'GoTemplars', link: 'https://gzngzn.github.io/go-temp/', desc: 'A platform for managing a mobile travel app, with the ability to edit cities, routes, and sights.',
                img: './assets/img/code1.jpg', tech: ['fab fa-angular', 'fab fa-js', 'fas fa-fire'] },
        ];
    }
};
...
module.exports = __webpack_require__(/*! D:\Angular\MyTestProjects\AnimationTest\myDesApp1\src\main.ts */"./src/main.ts");
